...
public class SecurityConfig {
    ...
    @Bean
    public ContextSource contextSource(LdifImportService ldifImportService) {
        int port = ldifImportService.getPort();
        return new DefaultSpringSecurityContextSource("ldap://localhost:" + port + "/dc=test,dc=bpab,dc=internal");
    }
